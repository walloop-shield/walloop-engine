...
import io.walloop.engine.conversion.ConversionOrderEntity;
import io.walloop.engine.conversion.ConversionOrderRepository;
import io.walloop.engine.conversion.ConversionPartner;
import io.walloop.engine.core.DepositWatchEntity;
import io.walloop.engine.core.DepositWatchRepository;
import io.walloop.engine.core.WithdrawalTransactionRepository;
import io.walloop.engine.fee.FeeCalculationEntity;
import io.walloop.engine.fee.FeeCalculationRepository;
import io.walloop.engine.fee.FxRateProvider;
import io.walloop.engine.fee.FxRateSnapshot;
...
import io.walloop.engine.network.NetworkAssetService;
import io.walloop.engine.swap.SwapQuoteEntity;
import io.walloop.engine.swap.SwapQuoteRepository;
...
public class FeeCalculationService {
    ...
    public long calculateFee(UUID transactionId, UUID ownerId) {
        ...
        log.info(
                "FeeCalculationService - fee calculated processId={} percent={} sats={} onchainSats={} totalSats={}",
                transactionId,
                feePercent,
                feeSats,
                onchainFeeSats,
